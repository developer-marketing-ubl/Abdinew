...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtNip = (EditText) findViewById(R.id.etNIP);
        btnLogin = (Button) findViewById(R.id.btnLogin);

        final ActionBar actionBar = getSupportActionBar();
        actionBar.hide();

        session = new SessionSharePreference(LoginActivity.this.getApplicationContext());
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(txtNip.getText().toString().isEmpty()){
                    txtNip.setError("Username harus di Isi !");
                }else{
                    loginUser(txtNip.getText().toString().trim());
                }
            }
        });
        ...
        class LoginAsync extends AsyncTask<String, Void, String> {
            ...
            protected void onPostExecute(String result){
                ...
                if(s.equalsIgnoreCase("success")){
                    String nama = String.valueOf(txtNip.getText());
                    session.setNama(nama);
                    Intent intent = new Intent(LoginActivity.this, BerandaActivity.class);
                    intent.putExtra(USER_NAME, txtNip.getText().toString().trim());
                    finish();
                    startActivity(intent);
                }else {
